...
| --- | --- | --- | --- | --- |
| `date` | `date` | `Date \| string` | `new Date()` | The date/time to format. |
...
| `hourFormat` | `hour-format` | `'auto' \| '12' \| '24'` | `'auto'` | Forces 12-hour or 24-hour time, or 'auto' for the locale default. |
