...
| `signDisplay` | `sign-display` | `'auto' \| 'never' \| 'always' \| 'exceptZero'` | `'auto'` | Controls when the positive/negative sign is displayed. |
...
| Method | Description |
| --- | --- |
| `formattedValue(): string` | Returns the most recently formatted string value. |
