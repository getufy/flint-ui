...
export function generateWrapper(
    ...
    lines.push(`//`);
    lines.push(`// Event naming: onFlint[ComponentName][EventType] (e.g. onFlintPaginationChange).`);
    lines.push(`// The props interface is strict — misspelled event names like onFlintPageChange`);
    lines.push(`// will cause a TypeScript error. No index signature is used.`);
    lines.push('');
