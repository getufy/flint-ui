...
describe('ui-input', () => {
    ...
    it('renders placeholder on the native input', async () => {
        const el = await fixture<UiInput>(html`<ui-input placeholder="Type here"></ui-input>`);
    ...
    it('links label to input via for/id', async () => {
        const el = await fixture<UiInput>(html`<ui-input label="Email"></ui-input>`);
        const label = el.shadowRoot!.querySelector('label')!;
        const input = el.shadowRoot!.querySelector('input')!;
    ...
    it('generates unique ids for multiple instances', async () => {
        const a = await fixture<UiInput>(html`<ui-input label="A"></ui-input>`);
        const b = await fixture<UiInput>(html`<ui-input label="B"></ui-input>`);
    ...
    it('sets aria-describedby when helpText is present', async () => {
        const el = await fixture<UiInput>(html`<ui-input help-text="Hint"></ui-input>`);
        const input = el.shadowRoot!.querySelector('input')!;
    ...
    it('sets aria-describedby to error paragraph when errorMessage present', async () => {
        const el = await fixture<UiInput>(html`<ui-input error-message="Bad value"></ui-input>`);
        const input = el.shadowRoot!.querySelector('input')!;
        const descId = input.getAttribute('aria-describedby')!;
        const desc = el.shadowRoot!.querySelector(`#${descId}`)!;
    ...
    it('error paragraph has role="alert"', async () => {
        const el = await fixture<UiInput>(html`<ui-input error-message="Oops"></ui-input>`);
    ...
    it('displays help text', async () => {
        const el = await fixture<UiInput>(html`<ui-input help-text="Helpful tip"></ui-input>`);
    ...
    it('displays error text over help text when both set', async () => {
        const el = await fixture<UiInput>(html`<ui-input help-text="Hint" error-message="Error!"></ui-input>`);
    ...
    it('dispatches ui-input-input with correct detail on input event', async () => {
        const el = await fixture<UiInput>(html`<ui-input></ui-input>`);
        const input = el.shadowRoot!.querySelector('input')!;

        const spy = vi.fn();
        el.addEventListener('ui-input-input', spy);
    ...
    it('dispatches ui-input-change with correct detail on change event', async () => {
        const el = await fixture<UiInput>(html`<ui-input></ui-input>`);
        const input = el.shadowRoot!.querySelector('input')!;

        const spy = vi.fn();
        el.addEventListener('ui-input-change', spy);
    ...
    it('events bubble and are composed', async () => {
        ...
        let bubbled = false;
        document.addEventListener('ui-input-input', () => { bubbled = true; }, { once: true });
