...
import styles from './ui-format-date.css?inline';
 ...
 *
 * @cssprop --ui-format-date-color      - Text color (default: `inherit`).
 * @cssprop --ui-format-date-font-size  - Font size (default: `inherit`).
 */
@customElement('ui-format-date')
export class UiFormatDate extends LitElement {
