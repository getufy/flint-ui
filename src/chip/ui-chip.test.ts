...
describe('ui-chip', () => {
    ...
    it('renders empty label by default', async () => {
        const el = await fixture<UiChip>(html`<ui-chip></ui-chip>`);
    ...
    it('does not add primary class for default color', async () => {
        const el = await fixture<UiChip>(html`<ui-chip label="Default"></ui-chip>`);
    ...
    it('does not add disabled class when not disabled', async () => {
        const el = await fixture<UiChip>(html`<ui-chip label="Active"></ui-chip>`);
    ...
    it('defaults to size md (no size-sm or size-lg class)', async () => {
        const el = await fixture<UiChip>(html`<ui-chip label="Default Size"></ui-chip>`);
    ...
    it('adds size-sm class when size is sm', async () => {
        const el = await fixture<UiChip>(html`<ui-chip label="Small" size="sm"></ui-chip>`);
    ...
    it('adds size-lg class when size is lg', async () => {
        const el = await fixture<UiChip>(html`<ui-chip label="Large" size="lg"></ui-chip>`);
    ...
    it('click event bubbles to parent element', async () => {
        ...
        const el = await fixture<UiChip>(html`<ui-chip label="Bubble" clickable></ui-chip>`, { parentNode: wrapper });
        el.shadowRoot!.querySelector('.chip')!.dispatchEvent(new MouseEvent('click', { bubbles: true, composed: true }));
        expect(handler).toHaveBeenCalledTimes(1);
        wrapper.remove();
    });
    ...
    it('delete event bubbles to parent element', async () => {
        ...
        const el = await fixture<UiChip>(html`<ui-chip label="Delete Bubble" deletable></ui-chip>`, { parentNode: wrapper });
        el.shadowRoot!.querySelector('.delete-icon')!.dispatchEvent(new MouseEvent('click', { bubbles: true, composed: true }));
        expect(handler).toHaveBeenCalledTimes(1);
        wrapper.remove();
    });
