...
export const Playground: Story = {
    render: (args: Record<string, unknown>) => html`
        <ui-rating
            ...
            @ui-rating-change=${(e: CustomEvent) => console.log('ui-rating-change:', e.detail.value)}
        ></ui-rating>
    `,
};
    ...
    render: () => html`
        <div style="display: flex; flex-direction: column; gap: 16px; font-family: var(--ui-font-family);">
            ...
            <div>
                ...
                <ui-rating disabled .value=${0}></ui-rating>
            </div>
        </div>
    `,
};
...
export const Clearable: Story = {
    render: () => html`
        <div style="font-family: var(--ui-font-family);">
            ...
            <ui-rating .value=${3} clearable size="lg"
                @ui-rating-change=${(e: CustomEvent) => console.log('value:', e.detail.value)}
            ></ui-rating>
        </div>
    `,
};
    ...
    render: () => html`
        <div style="display: flex; flex-direction: column; gap: 16px; font-family: var(--ui-font-family);">
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    ${[1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5].map(v => html`
                        <div style="display: flex; align-items: center; gap: 12px;">
                            ...
                            <ui-rating .value=${v} .precision=${0.5 as const} readonly size="sm"></ui-rating>
                        </div>
                    `)}
                </div>
            </div>
            <div>
                ...
                <ui-rating .value=${2.5} .precision=${0.5 as const} size="lg"
                    @ui-rating-change=${(e: CustomEvent) => console.log('value:', e.detail.value)}
                ></ui-rating>
            </div>
        </div>
    ...
    render: () => html`
        <div style="display: flex; flex-direction: column; gap: 16px; font-family: var(--ui-font-family);">
            <div>
                ...
                <ui-rating .value=${3} style="--ui-rating-color: #ef4444;" size="lg"></ui-rating>
            </div>
            <div>
                <p style="font-size: 13px; color: #6b7280; margin: 0 0 8px;">Green / Success</p>
                <ui-rating .value=${5} style="--ui-rating-color: #22c55e;" size="lg"></ui-rating>
            </div>
            <div>
                <p style="font-size: 13px; color: #6b7280; margin: 0 0 8px;">Purple</p>
                <ui-rating .value=${4} style="--ui-rating-color: #a855f7;" size="lg"></ui-rating>
            </div>
        </div>
    `,
};
...
export const Controlled: Story = {
    render: () => {
        const ratingRef = createRef<UiRating>();
            ...
            <div style="display: flex; flex-direction: column; gap: 16px; font-family: var(--ui-font-family);">
                <div style="display: flex; align-items: center; gap: 16px;">
                    <ui-rating
                        ...
                        .value=${3}
                        size="lg"
                        @ui-rating-change=${(e: CustomEvent) => {
                ...
                <ui-button variant="secondary" size="small" @click=${onReset}>Reset</ui-button>
            </div>
        `;
    },
};
...
export const Uncontrolled: Story = {
    render: () => html`
        <div style="font-family: var(--ui-font-family);">
            ...
            <ui-rating .defaultValue=${2} size="lg"
                @ui-rating-change=${(e: CustomEvent) => console.log('value:', e.detail.value)}
            ></ui-rating>
        </div>
    `,
...
export const FormIntegration: Story = {
    render: () => {
        ...
        return html`
            <form @submit=${onSubmit} style="display: flex; flex-direction: column; gap: 16px; max-width: 300px; font-family: var(--ui-font-family);">
                <label style="font-weight: 600; font-size: 14px;">Rate this product</label>
                <ui-rating name="product-rating" .value=${0} size="lg"></ui-rating>
                <ui-button type="submit" variant="primary" size="medium">Submit Review</ui-button>
            </form>
        `;
    },
};
    ...
    render: () => html`
        <div style="max-width: 400px; padding: 24px; background: var(--ui-surface-background); border-radius: 12px; box-shadow: var(--ui-shadow-md); font-family: var(--ui-font-family);">
            ...
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
                <ui-rating .value=${4} readonly size="sm"></ui-rating>
            ...
            <ui-rating .value=${0} size="md" clearable style="margin-bottom: 16px;"
                @ui-rating-change=${(e: CustomEvent) => console.log('Rating:', e.detail.value)}
            ></ui-rating>
