...
export const AdjustableLatency: Story = {
    ...
    render: () => {
        ...
        const rebuild = () => {
            const tree = document.getElementById('lazy-latency-tree') as UiRichTreeView | null;
...
export const LazyWithControlledExpansion: Story = {
    ...
    render: () => {
        ...
        const onExpandedItemsChange = (ids: string[]) => {
            expandedItems = ids;
            const tree = document.getElementById('lazy-controlled-tree') as UiRichTreeView | null;
