import { LitElement, unsafeCSS, html, nothing, svg } from 'lit';
import { customElement, property } from 'lit/decorators.js';
import { classMap } from 'lit/directives/class-map.js';
import styles from './ui-copy-button.css?inline';
...
export class UiCopyButton extends LitElement {
    ...
    private _tooltipId = `ui-copy-tooltip-${instanceCounter++}`;
    ...
    private async _handleClick(): Promise<void> {
        ...
        try {
            ...
            this.dispatchEvent(new CustomEvent('ui-copy', {
                detail: { value: text },
                bubbles: true,
                composed: true,
            }));
