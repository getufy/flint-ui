...
import styles from './ui-image-comparer.css?inline';

/**
 * `ui-image-comparer` — Compare two images side-by-side with a draggable slider.
 *
 ...
 *
 * @cssprop --ui-image-comparer-divider-width        - Width of the divider line.
 * @cssprop --ui-image-comparer-divider-color        - Color of the divider line.
 * @cssprop --ui-image-comparer-handle-size           - Diameter of the handle circle.
 * @cssprop --ui-image-comparer-handle-bg             - Handle background color.
 * @cssprop --ui-image-comparer-handle-border-color   - Handle border color.
 * @cssprop --ui-image-comparer-handle-icon-color     - Handle icon color.
 * @cssprop --ui-image-comparer-border-radius         - Border radius of the component.
 * @cssprop --ui-image-comparer-aspect-ratio          - Aspect ratio of the component (default: 16 / 9).
 *
 * @fires ui-image-comparer-change - Fired when the position changes. Detail: `{ position: number }`.
 */
@customElement('ui-image-comparer')
export class UiImageComparer extends LitElement {
...
declare global {
    interface HTMLElementTagNameMap {
        'ui-image-comparer': UiImageComparer;
    }
}
