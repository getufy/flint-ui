...
import type { UiContainer } from './ui-container.js';
...
describe('ui-container', () => {
    ...
    it('has default maxWidth="lg"', async () => {
        const el = await fixture<UiContainer>(html`<ui-container>Content</ui-container>`);
    ...
    it('applies the correct class for "xs"', async () => {
        const el = await fixture<UiContainer>(html`<ui-container max-width="xs">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
    ...
    it('applies the correct class for "sm"', async () => {
        const el = await fixture<UiContainer>(html`<ui-container max-width="sm">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
    ...
    it('applies the correct class for "md"', async () => {
        const el = await fixture<UiContainer>(html`<ui-container max-width="md">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
    ...
    it('applies the correct class for "lg"', async () => {
        const el = await fixture<UiContainer>(html`<ui-container max-width="lg">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
    ...
    it('applies the correct class for "xl"', async () => {
        const el = await fixture<UiContainer>(html`<ui-container max-width="xl">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
    ...
    it('parses attribute "false" as boolean false', async () => {
        const el = await fixture<UiContainer>(html`<ui-container max-width="false">Content</ui-container>`);
        await el.updateComplete;
    ...
    it('applies the correct class when disable-gutters is set', async () => {
        const el = await fixture<UiContainer>(html`<ui-container disable-gutters>Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
    ...
    it('reflects the "fixed" property and applies class', async () => {
        const el = await fixture<UiContainer>(html`<ui-container fixed>Content</ui-container>`);
        await el.updateComplete;
    ...
    it('fixed=true + maxWidth="xs" applies both classes (regression: was collapsing to max-width:0)', async () => {
        const el = await fixture<UiContainer>(html`<ui-container fixed max-width="xs">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
        expect(container?.classList.contains('fixed')).toBe(true);
        expect(container?.classList.contains('max-width-xs')).toBe(true);
    ...
    it('renders slotted content', async () => {
        const el = await fixture<UiContainer>(html`<ui-container><span id="child">Hello</span></ui-container>`);
    ...
    it('disableGutters and fixed can be combined', async () => {
        const el = await fixture<UiContainer>(html`<ui-container disable-gutters fixed max-width="md">Content</ui-container>`);
        await el.updateComplete;
        const container = el.shadowRoot?.querySelector('.container');
        expect(container?.classList.contains('disable-gutters')).toBe(true);
        expect(container?.classList.contains('fixed')).toBe(true);
