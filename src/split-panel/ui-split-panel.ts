...
/**
 * `ui-split-panel` — Two adjacent panels separated by a draggable divider.
 *
 ...
 *
 * @cssprop --ui-split-panel-divider-width      - Width/height of the visible divider line (default: 4px).
 * @cssprop --ui-split-panel-divider-hit-area   - Invisible grab area around the divider (default: 12px).
 * @cssprop --ui-split-panel-divider-color      - Divider background color (default: --ui-border-color).
 * @cssprop --ui-split-panel-divider-hover-color - Divider color when hovered or focused.
 * @cssprop --ui-split-panel-min               - Minimum size of the primary panel (default: 0).
 * @cssprop --ui-split-panel-max               - Maximum size of the primary panel (default: 100%).
 *
 * @fires ui-split-panel-reposition - Emitted when the divider position changes.
 *   Detail: `{ position: number; positionInPixels: number }`.
 */
@customElement('ui-split-panel')
export class UiSplitPanel extends LitElement {
