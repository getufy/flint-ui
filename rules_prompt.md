...
We are currently writing a lit component. This component will be used by hundreds of people in different projects. Look into folder named "Resizable" and update the component, the css file, the story and test files. Create, refine stories and tests. Look into theme.css or theme-dark.css for variables or add variables there.
