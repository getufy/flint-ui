 ...
 */
@customElement('flint-collapsible-trigger')
export class FlintCollapsibleTrigger extends LitElement {
 ...
 */
@customElement('flint-collapsible-content')
export class FlintCollapsibleContent extends LitElement {
 ...
 */
@customElement('flint-collapsible')
export class FlintCollapsible extends LitElement {
