...
export const Playground: Story = {
    name: 'Playground',
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px; max-width: 480px;">
            <p style="margin: 0 0 12px; font-size: 0.875rem; color: var(--ui-text-color-muted, #6b7280);">
            ...
            <ui-visually-hidden>This text is hidden visually but accessible to screen readers.</ui-visually-hidden>
            <p style="
                font-size: 0.875rem; color: var(--ui-text-color, #111827);
                padding: 12px 16px;
                background: var(--ui-surface-2, #f9fafb);
...
export const SkipLink: Story = {
    ...
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px;">
            <p style="margin: 0 0 12px; font-size: 0.875rem; color: var(--ui-text-color-muted, #6b7280);">
                Press <kbd style="
                    display: inline-block; padding: 2px 6px; font-size: 0.75rem;
                    background: var(--ui-surface-3, #f3f4f6); border: 1px solid var(--ui-border-color, #e5e7eb);
...
export const NewWindowLink: Story = {
    ...
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px;">
            <p style="margin: 0 0 16px; font-size: 0.875rem; color: var(--ui-text-color-muted, #6b7280);">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <a
                    ...
                    style="
                        ...
                        font-size: 0.9375rem; color: var(--ui-primary-color, #3b82f6);
...
export const FormLabels: Story = {
    ...
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px; max-width: 360px;">
            <p style="margin: 0 0 16px; font-size: 0.875rem; color: var(--ui-text-color-muted, #6b7280);">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 4px;">
                    <div>
                        <label style="display: block; margin-bottom: 4px;">
                            <ui-visually-hidden>Name</ui-visually-hidden>
                            <input
                                type="text"
                                placeholder="Name"
                                style="
                    ...
                    <div>
                        <label style="display: block; margin-bottom: 4px;">
                            <ui-visually-hidden>Email</ui-visually-hidden>
                            <input
                                type="email"
                                placeholder="Email"
                                style="
        ...
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px;">
            ...
            <div style="display: flex; gap: 8px;">
                ...
                <button style="
                    ...
                    background: var(--ui-surface-3, #f3f4f6);
                    color: var(--ui-text-color, #111827);
                ">
                    ...
                    <ui-visually-hidden not-focusable>Delete item</ui-visually-hidden>
                </button>
                ...
                ">
                    ...
                    <ui-visually-hidden not-focusable>Edit item</ui-visually-hidden>
                </button>
                ...
                ">
                    ...
                    <ui-visually-hidden not-focusable>Share item</ui-visually-hidden>
                </button>
            </div>
        </div>
    `,
    ...
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px;">
            ...
            <nav aria-label="breadcrumb">
                ...
                ">
                    <li>
                        <a href="#" style="color: var(--ui-primary-color, #3b82f6); text-decoration: none;">Home</a>
                    </li>
                    <li aria-hidden="true" style="color: var(--ui-text-color-muted, #9ca3af); padding: 0 2px;">/</li>
                    <li>
                        <a href="#" style="color: var(--ui-primary-color, #3b82f6); text-decoration: none;">Products</a>
                    </li>
                    <li aria-hidden="true" style="color: var(--ui-text-color-muted, #9ca3af); padding: 0 2px;">/</li>
                    <li>
                        <span style="font-weight: 500;">
                            Wireless Headphones
                            <ui-visually-hidden not-focusable>(current page)</ui-visually-hidden>
                        </span>
                    </li>
                </ol>
            </nav>
...
export const LiveAnnouncement: Story = {
    ...
    render: () => {
        let count = 0;
        return html`
            <div style="font-family: var(--ui-font-family, system-ui); padding: 24px; max-width: 400px;">
                <p style="margin: 0 0 16px; font-size: 0.875rem; color: var(--ui-text-color-muted, #6b7280);">
                    A hidden live region announces status updates to screen readers
                    without disrupting the visual layout.
                </p>
                <ui-visually-hidden not-focusable>
                ...
                <div style="display: flex; align-items: center; gap: 12px;">
                    <button
                        ...
                        style="
                            ...
                            background: var(--ui-primary-color, #3b82f6); color: #fff;
                    ...
                    <span id="cart-display" style="
                        font-size: 0.875rem; color: var(--ui-text-color-muted, #6b7280);
                    ">
                        Click to add items
                    </span>
                </div>
    ...
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px;">
            ...
            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 8px;">
                <!-- Online user -->
                <li style="display: flex; align-items: center; gap: 10px; font-size: 0.9375rem; color: var(--ui-text-color, #111827);">
                    <span style="
                    ...
                    ">
                        ...
                        <span style="
                            ...
                            background: #22c55e;
                            border: 2px solid var(--ui-surface-1, #fff);
                        " aria-hidden="true"></span>
                    </span>
                    Alex Johnson
                    <ui-visually-hidden not-focusable>(online)</ui-visually-hidden>
                </li>
                <!-- Away user -->
                <li style="display: flex; align-items: center; gap: 10px; font-size: 0.9375rem; color: var(--ui-text-color, #111827);">
                    <span style="
                    ...
                    Sam Kim
                    <ui-visually-hidden not-focusable>(away)</ui-visually-hidden>
                </li>
                <!-- Offline user -->
                <li style="display: flex; align-items: center; gap: 10px; font-size: 0.9375rem; color: var(--ui-text-color, #111827);">
                    <span style="
                    ...
                    Morgan Lee
                    <ui-visually-hidden not-focusable>(offline)</ui-visually-hidden>
                </li>
            </ul>
        </div>
    `,
...
export const DataTable: Story = {
    ...
    render: () => html`
        <div style="font-family: var(--ui-font-family, system-ui); padding: 24px;">
            ...
            ">
                <thead>
                    <tr style="border-bottom: 2px solid var(--ui-border-color, #e5e7eb);">
                        <th style="padding: 8px 12px; text-align: left; font-weight: 600;">
                            <button style="
                                ...
                                color: var(--ui-text-color, #111827); padding: 0;
                            ">
                                Name
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                     viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <ui-visually-hidden not-focusable>sorted ascending</ui-visually-hidden>
                            </button>
                        </th>
                        ...
                        <th style="padding: 8px 12px; text-align: right; font-weight: 600;">
                            <ui-visually-hidden not-focusable>Actions</ui-visually-hidden>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="border-bottom: 1px solid var(--ui-border-color, #e5e7eb);">
                        <td style="padding: 10px 12px;">Alex Johnson</td>
                        <td style="padding: 10px 12px;">Admin</td>
                        <td style="padding: 10px 12px;">
                            <span style="color: #16a34a;">● <ui-visually-hidden not-focusable>Status:</ui-visually-hidden> Active</span>
                        </td>
                        <td style="padding: 10px 12px; text-align: right;">
                            ...
                            ">
                                Edit
                                <ui-visually-hidden not-focusable>Alex Johnson</ui-visually-hidden>
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding: 10px 12px;">
                            <span style="color: #ca8a04;">● <ui-visually-hidden not-focusable>Status:</ui-visually-hidden> Pending</span>
                        </td>
                        <td style="padding: 10px 12px; text-align: right;">
                            <button style="
                                padding: 4px 10px; font-size: 0.8125rem; cursor: pointer;
                            ...
                            ">
                                Edit
                                <ui-visually-hidden not-focusable>Sam Kim</ui-visually-hidden>
                            </button>
                        </td>
                    </tr>
                </tbody>
