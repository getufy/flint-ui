...
const meta: Meta = {
    ...
    component: 'ui-bottom-navigation',
    argTypes: {
        value: { control: 'text' },
    ...
    render: (args) => html`
        <ui-box width="500px" border="1px solid #ddd" bgcolor="var(--ui-muted-background, #f5f5f5)" style="padding-top: 50px;">
            <ui-bottom-navigation
                ...
                @ui-bottom-navigation-change=${(e: Event) => {
                    const detail = (e as CustomEvent).detail;
                    console.log('Selection changed to:', detail.value);
                }}
            >
                <ui-bottom-navigation-action label=${args.label1} value="recents">
                    <span slot="icon">${icons.restore}</span>
                </ui-bottom-navigation-action>
                <ui-bottom-navigation-action label=${args.label2} value="favs">
                    <span slot="icon">${icons.favorites}</span>
                </ui-bottom-navigation-action>
                <ui-bottom-navigation-action label=${args.label3} value="nearby">
    ...
    render: (args) => html`
        <ui-box width="500px" border="1px solid #ddd" bgcolor="var(--ui-muted-background, #f5f5f5)" style="padding-top: 50px;">
            ...
            >
                ...
                <ui-bottom-navigation-action label=${args.label4} value="folder">
    ...
    render: (args) => html`
        <ui-box width="500px" border="1px solid #ddd" bgcolor="var(--ui-muted-background, #f5f5f5)" style="padding-top: 50px;">
            <ui-bottom-navigation .value=${args.value} ?show-labels=${args.showLabels}>
                ...
                <ui-bottom-navigation-action value="favs">
                    <span slot="icon">${icons.favorites}</span>
                </ui-bottom-navigation-action>
                <ui-bottom-navigation-action value="nearby">
                    <span slot="icon">${icons.nearby}</span>
                </ui-bottom-navigation-action>
                <ui-bottom-navigation-action value="folder">
                    <span slot="icon">${icons.folder}</span>
                </ui-bottom-navigation-action>
            </ui-bottom-navigation>
        </ui-box>
