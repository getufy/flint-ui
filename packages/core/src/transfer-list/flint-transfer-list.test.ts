...
describe('flint-transfer-list', () => {
    ...
    it('renders correctly with options', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${['1']}></flint-transfer-list>
        `);
    ...
    it('renders default titles', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions}></flint-transfer-list>
        `);
    ...
    it('renders custom titles', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} leftTitle="Available" rightTitle="Chosen"></flint-transfer-list>
        `);
    ...
    it('renders empty right list gracefully', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${[]}></flint-transfer-list>
        `);
    ...
    it('renders empty left list gracefully when all items selected', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${['1', '2', '3']}></flint-transfer-list>
        `);
    ...
    it('moves selected items from right to left', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${['1', '2']}></flint-transfer-list>
        `);
    ...
    it('disables all action buttons when disabled prop is set', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${['1']} ?disabled=${true}></flint-transfer-list>
        `);
    ...
    it('reflects disabled attribute', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} ?disabled=${true}></flint-transfer-list>
        `);
    ...
    it('applies defaultValue as initial right list on first render', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .defaultValue=${['1', '2']}></flint-transfer-list>
        `);
    ...
    it('defaultValue is ignored when value is already set', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${['3']} .defaultValue=${['1', '2']}></flint-transfer-list>
        `);
    ...
    it('empty defaultValue leaves value as empty', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .defaultValue=${[]}></flint-transfer-list>
        `);
    ...
    it('renders search inputs when searchable is true', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${[]} ?searchable=${true}></flint-transfer-list>
        `);
    ...
    it('filters right list by search query', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${['1', '2', '3']} ?searchable=${true}></flint-transfer-list>
        `);
    ...
    it('search inputs are disabled when component is disabled', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${[]} ?searchable=${true} ?disabled=${true}></flint-transfer-list>
        `);
    ...
    it('sets aria-label from leftTitle and rightTitle on listboxes', async () => {
        const el = await fixture<FlintTransferList>(html`
            <flint-transfer-list .options=${defaultOptions} .value=${[]} leftTitle="Available" rightTitle="Chosen"></flint-transfer-list>
        `);
