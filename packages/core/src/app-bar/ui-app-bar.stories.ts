...
export const TitleOnly: Story = {
    ...
    render: (args) => html`
    <ui-app-bar .title=${args.title} .variant=${args.variant}></ui-app-bar>
  `,
};
...
export const WithMultipleActions: Story = {
    ...
    <ui-app-bar .title=${args.title} .variant=${args.variant}>
      ...
      <div slot="actions" style="display: flex; gap: 8px;">
        <ui-button variant="secondary" size="small" style="--ui-secondary-color: transparent; color: white;">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <ui-button variant="secondary" size="small" style="--ui-secondary-color: transparent; color: white;">Profile</ui-button>
      </div>
    </ui-app-bar>
  `,
};
