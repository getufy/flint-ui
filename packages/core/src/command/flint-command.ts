 ...
 */
@customElement('flint-command-shortcut')
export class FlintCommandShortcut extends LitElement {
...
@customElement('flint-command-separator')
export class FlintCommandSeparator extends LitElement {
 ...
 */
@customElement('flint-command-item')
export class FlintCommandItem extends LitElement {
 ...
 */
@customElement('flint-command-empty')
export class FlintCommandEmpty extends LitElement {
 ...
 */
@customElement('flint-command-group')
export class FlintCommandGroup extends LitElement {
 ...
 */
@customElement('flint-command-list')
export class FlintCommandList extends LitElement {
 ...
 */
@customElement('flint-command-input')
export class FlintCommandInput extends LitElement {
 ...
 * </flint-command>
 */
@customElement('flint-command')
export class FlintCommand extends LitElement {
 ...
 * </flint-command-dialog>
 */
@customElement('flint-command-dialog')
export class FlintCommandDialog extends LitElement {
