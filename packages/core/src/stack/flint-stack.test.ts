...
interface StackInternal {
    ...
    direction: FlintStack['direction'];
    remove(): void;
}

function clearBpCache() {
    (FlintStack as unknown as { _breakPoints: Record<string, number> })._breakPoints = {};
}

describe('flint-stack', () => {
    ...
    it('is defined', () => {
        expect(document.createElement('flint-stack')).toBeInstanceOf(HTMLElement);
    });

    it('renders a .stack-wrapper div', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack></flint-stack>`);
    ...
    it('renders slotted children', async () => {
        const el = await fixture<FlintStack>(html`
            <flint-stack><div id="child">item</div></flint-stack>
        `);
    ...
    it('applies row direction via attribute', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack direction="row"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('applies column-reverse direction', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack direction="column-reverse"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
        expect(wrapper.style.flexDirection).toBe('column-reverse');
    });

    it('applies row-reverse direction', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack direction="row-reverse"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('converts numeric spacing to px gap (× 8)', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack spacing="2"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('passes string spacing through unchanged', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .spacing=${'2rem'}></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
        expect(wrapper.style.gap).toBe('2rem');
    });

    it('sets --flint-stack-spacing custom property', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack spacing="2"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
        expect(wrapper.style.getPropertyValue('--flint-stack-spacing')).toBe('16px');
    });

    // ── alignItems / justifyContent ────────────────────────────────────────

    it('defaults alignItems to stretch for column', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack direction="column"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('applies explicit alignItems override', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack direction="row" .alignItems=${'flex-start'}></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('applies all alignItems values', async () => {
        for (const val of ['flex-start', 'center', 'flex-end', 'stretch', 'baseline'] as const) {
            const el = await fixture<FlintStack>(html`<flint-stack .alignItems=${val}></flint-stack>`);
            const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('applies explicit justifyContent', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .justifyContent=${'space-between'}></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('applies all justifyContent values', async () => {
        for (const val of ['flex-start', 'center', 'flex-end', 'space-between', 'space-around', 'space-evenly'] as const) {
            const el = await fixture<FlintStack>(html`<flint-stack .justifyContent=${val}></flint-stack>`);
            const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
    ...
    it('still sets --flint-stack-spacing when useFlexGap=false', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .useFlexGap=${false} spacing="2"></flint-stack>`);
        const wrapper = el.shadowRoot!.querySelector('.stack-wrapper') as HTMLElement;
        expect(wrapper.style.getPropertyValue('--flint-stack-spacing')).toBe('16px');
    });
    ...
    it('resolves xs direction at 375px', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .direction=${{ xs: 'column', sm: 'row' }}></flint-stack>`);
    ...
    it('resolves md direction at 950px', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .direction=${{ xs: 'column', md: 'row' }}></flint-stack>`);
    ...
    it('resolves lg direction at 1250px', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .direction=${{ xs: 'column', lg: 'row' }}></flint-stack>`);
    ...
    it('resolves xl direction at 1600px', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .direction=${{ xs: 'column', xl: 'row' }}></flint-stack>`);
    ...
    it('cascades direction to lower breakpoint when current not defined', async () => {
        ...
        const el = await fixture<FlintStack>(html`<flint-stack .direction=${{ xs: 'column-reverse', lg: 'row' }}></flint-stack>`);
    ...
    it('falls back to first defined breakpoint key when no lower bps match', async () => {
        ...
        const el = await fixture<FlintStack>(html`<flint-stack .direction=${{ md: 'row-reverse' }}></flint-stack>`);
    ...
    it('handles responsive spacing', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack .spacing=${{ xs: 1, md: 3 }}></flint-stack>`);
        (el as unknown as StackInternal)._currentWidth = 375;
        await el.updateComplete;
        expect(
    ...
    it('_getBreakpointValue returns cached value without calling getComputedStyle', () => {
        (FlintStack as unknown as { _breakPoints: Record<string, number> })._breakPoints['cached-sm'] = 777;
    ...
    it('_getBreakpointValue reads and caches CSS custom property value', () => {
        ...
        expect(
            (FlintStack as unknown as { _breakPoints: Record<string, number> })._breakPoints['css-var-bp']
        ).toBe(800);
    });
    ...
    it('adds resize listener on connectedCallback', async () => {
        ...
        await fixture<FlintStack>(html`<flint-stack></flint-stack>`);
    ...
    it('_onResize updates _currentWidth and re-renders', async () => {
        const el = await fixture<FlintStack>(html`
            <flint-stack .direction=${{ xs: 'column', sm: 'row' }}></flint-stack>
        `);
        // Set to xs first
        (el as unknown as StackInternal)._currentWidth = 375;
        await el.updateComplete;
    ...
    it('sets divider orientation to horizontal for column stack', async () => {
        const el = await fixture<FlintStack>(html`
            <flint-stack direction="column">
                <flint-divider></flint-divider>
            </flint-stack>
        `);
        await el.updateComplete;
        expect(el.querySelector('flint-divider')!.getAttribute('orientation')).toBe('horizontal');
    });

    it('sets divider orientation to vertical for row-reverse stack', async () => {
        const el = await fixture<FlintStack>(html`
            <flint-stack direction="row-reverse">
                <flint-divider></flint-divider>
            </flint-stack>
        `);
        await el.updateComplete;
    ...
    it('sets divider orientation to horizontal for column-reverse stack', async () => {
        const el = await fixture<FlintStack>(html`
            <flint-stack direction="column-reverse">
                <flint-divider></flint-divider>
            </flint-stack>
        `);
        await el.updateComplete;
    ...
    it('skips setAttribute when divider orientation already correct', async () => {
        ...
        `);
        await el.updateComplete;
        const divider = el.querySelector('flint-divider')!;
    ...
    it('_updateDividers handles stack with no dividers', async () => {
        const el = await fixture<FlintStack>(html`<flint-stack direction="row"><div>item</div></flint-stack>`);
        await el.updateComplete;
        // Should not throw
    ...
    it('updates orientation on multiple dividers', async () => {
        ...
        `);
        await el.updateComplete;
        const dividers = el.querySelectorAll('flint-divider');
