...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — rendering
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — rendering', () => {
    ...
    it('sets datetime attribute to ISO string', async () => {
        ...
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date}></flint-relative-time>`);
        const time = el.shadowRoot!.querySelector('time')!;
    ...
    it('renders empty string for an invalid date string', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time date="not-a-date"></flint-relative-time>`);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — date prop
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — date prop', () => {
    ...
    it('accepts an ISO 8601 string', async () => {
        ...
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time date=${iso}></flint-relative-time>`);
        expect(shadowText(el).length).toBeGreaterThan(0);
    });

    it('updates when the date property changes', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${new Date(Date.now() - 60_000)}></flint-relative-time>`);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — relative unit selection
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — unit selection', () => {
    const rtf = (diff: number) => {
        const date = new Date(Date.now() + diff);
        return fixture<FlintRelativeTime>(html`
            <flint-relative-time .date=${date} numeric="always"></flint-relative-time>
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — format prop
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — format prop', () => {
    ...
    it('reflects format attribute', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} format="short"></flint-relative-time>`);
    ...
    it('long format produces longer output than narrow', async () => {
        const [elLong, elNarrow] = await Promise.all([
            fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} format="long"></flint-relative-time>`),
            fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} format="narrow"></flint-relative-time>`),
        ]);
    ...
    it('accepts format="narrow"', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} format="narrow"></flint-relative-time>`);
        expect(el.format).toBe('narrow');
        expect(shadowText(el).length).toBeGreaterThan(0);
    });

    it('updates text when format changes', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} format="long"></flint-relative-time>`);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — numeric prop
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — numeric prop', () => {
    ...
    it('reflects numeric attribute', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time numeric="always"></flint-relative-time>`);
        expect(el.getAttribute('numeric')).toBe('always');
    });

    it('numeric="auto" can produce "yesterday" for en locale', async () => {
        const yesterday = new Date(Date.now() - 86_400_000);
        const el = await fixture<FlintRelativeTime>(html`
            <flint-relative-time .date=${yesterday} numeric="auto" lang="en"></flint-relative-time>
        `);
    ...
    it('numeric="always" does not produce "yesterday"', async () => {
        const yesterday = new Date(Date.now() - 86_400_000);
        const el = await fixture<FlintRelativeTime>(html`
            <flint-relative-time .date=${yesterday} numeric="always" lang="en"></flint-relative-time>
        `);
        const text = shadowText(el);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — sync prop
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — sync prop', () => {
    beforeEach(() => {
        vi.useFakeTimers();
    });
    ...
    it('reflects sync as boolean attribute', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time sync></flint-relative-time>`);
    ...
    it('triggers requestUpdate after timer fires', async () => {
        ...
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} sync></flint-relative-time>`);
        await el.updateComplete;
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — disconnectedCallback
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — disconnectedCallback', () => {
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — lang attribute
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — lang attribute', () => {
    const date = new Date(Date.now() - 400 * 86_400_000);

    it('produces different text for different lang values', async () => {
        const [elEn, elDe] = await Promise.all([
            fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} lang="en"></flint-relative-time>`),
            fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} lang="de"></flint-relative-time>`),
        ]);
        expect(shadowText(elEn)).not.toBe(shadowText(elDe));
    });

    it('renders with an unsupported lang without crashing', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} lang="xx-INVALID"></flint-relative-time>`);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — accessibility
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — accessibility', () => {
    it('uses semantic <time> element', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${new Date()}></flint-relative-time>`);
        expect(el.shadowRoot!.querySelector('time')).not.toBeNull();
    });
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — default prop values
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — default props', () => {
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — lang reactivity
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — lang reactivity', () => {
    const date = new Date(Date.now() - 400 * 86_400_000);

    it('re-renders when lang property changes', async () => {
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} lang="en"></flint-relative-time>`);
        const before = shadowText(el);
        el.lang = 'de';
        await el.updateComplete;
        const after = shadowText(el);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — number timestamp support
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — number timestamp', () => {
    it('accepts a Unix ms timestamp', async () => {
        const ts = Date.now() - 5 * 60 * 1000;
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${ts}></flint-relative-time>`);
        expect(shadowText(el).length).toBeGreaterThan(0);
    });
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — aria-label
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — aria-label', () => {
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — numeric change
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — numeric change', () => {
    it('updates text when numeric changes from auto to always', async () => {
        ...
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time .date=${date} numeric="auto" lang="en"></flint-relative-time>`);
        el.numeric = 'always';
        await el.updateComplete;
        const text = shadowText(el);
        expect(text).not.toBe('yesterday');
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — sync rescheduling
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — sync rescheduling', () => {
    beforeEach(() => { vi.useFakeTimers(); });
    afterEach(() => { vi.useRealTimers(); });

    it('reschedules timer when date changes while sync=true', async () => {
        const el = await fixture<FlintRelativeTime>(html`
            <flint-relative-time .date=${new Date(Date.now() - 30_000)} sync></flint-relative-time>
        `);
        await el.updateComplete;
    ...
    it('uses 60s fallback interval when date is invalid and sync=true', async () => {
        const setTimeoutSpy = vi.spyOn(globalThis, 'setTimeout');
        const el = await fixture<FlintRelativeTime>(html`<flint-relative-time date="bad" sync></flint-relative-time>`);
        await el.updateComplete;
    ...
    it('reschedules when format changes while sync=true', async () => {
        const el = await fixture<FlintRelativeTime>(html`
            <flint-relative-time .date=${new Date(Date.now() - 30_000)} sync format="long"></flint-relative-time>
        `);
        await el.updateComplete;
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — msUntilNextChange 3h+ interval
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — 3h+ sync interval', () => {
    beforeEach(() => { vi.useFakeTimers(); });
    afterEach(() => { vi.useRealTimers(); });
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — _formatText catch branch
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — _formatText catch branch', () => {
    it('returns empty string when Intl.RelativeTimeFormat throws', async () => {
        ...
        try {
            ...
            const el = await fixture<FlintRelativeTime>(html`
                <flint-relative-time .date=${date} lang="en"></flint-relative-time>
            `);
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — lang fallback chain
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — lang fallback chain', () => {
...
/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — CSS custom properties
═══════════════════════════════════════════════════════════════════════════ */
describe('flint-relative-time — CSS custom properties', () => {
    ...
    it('host has display inline by default', async () => {
        ...
        expect(el.tagName.toLowerCase()).toBe('flint-relative-time');
    });
});

/* ═══════════════════════════════════════════════════════════════════════════
   flint-relative-time — pickUnit export
═══════════════════════════════════════════════════════════════════════════ */
describe('pickUnit', () => {
