...
import styles from './ui-relative-time.css?inline';
 ...
 *
 * @cssprop --ui-relative-time-color      - Text color (default: `inherit`).
 * @cssprop --ui-relative-time-font-size  - Font size (default: `inherit`).
 */
@customElement('ui-relative-time')
export class UiRelativeTime extends LitElement {
