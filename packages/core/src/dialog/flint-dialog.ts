...
import '../backdrop/flint-backdrop';
 ...
 */
@customElement('flint-dialog')
export class FlintDialog extends LitElement {
 ...
 */
@customElement('flint-dialog-title')
export class FlintDialogTitle extends LitElement {
 ...
 */
@customElement('flint-dialog-content')
export class FlintDialogContent extends LitElement {
 ...
 */
@customElement('flint-dialog-content-text')
export class FlintDialogContentText extends LitElement {
 ...
 */
@customElement('flint-dialog-actions')
export class FlintDialogActions extends LitElement {
