 ...
 */
@customElement('flint-hover-card-trigger')
export class FlintHoverCardTrigger extends LitElement {
 ...
 */
@customElement('flint-hover-card-content')
export class FlintHoverCardContent extends LitElement {
    ...
    private _handleReposition(): void {
        ...
        const offset = 8; // matches --flint-hovercard-offset default
        ...
        if (side === 'bottom' || side === 'top') {
            if (side === 'bottom') {
                ...
                // We need to shift up by the content's own height
 ...
 */
@customElement('flint-hover-card')
export class FlintHoverCard extends LitElement {
    ...
    private _syncChildren() {
        this.querySelectorAll('flint-hover-card-content').forEach(el => {
            if (el.closest('flint-hover-card') === this) {
                ...
                (el as FlintHoverCardContent).hoist = this.hoist;
            }
        });
    }
