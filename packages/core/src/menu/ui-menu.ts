...
import uiMenuItemStyles from './ui-menu-item.css?inline';
import uiMenuDividerStyles from './ui-menu-divider.css?inline';
import uiMenuGroupStyles from './ui-menu-group.css?inline';
import uiMenuStyles from './ui-menu.css?inline';
