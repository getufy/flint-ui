 ...
 * @slot - Title text.
 */
@customElement('flint-item-title')
export class FlintItemTitle extends LitElement {
 ...
 */
@customElement('flint-item-description')
export class FlintItemDescription extends LitElement {
 ...
 */
@customElement('flint-item-content')
export class FlintItemContent extends LitElement {
 ...
 */
@customElement('flint-item-actions')
export class FlintItemActions extends LitElement {
 ...
 */
@customElement('flint-item-header')
export class FlintItemHeader extends LitElement {
 ...
 */
@customElement('flint-item-footer')
export class FlintItemFooter extends LitElement {
 ...
 */
@customElement('flint-item-separator')
export class FlintItemSeparator extends LitElement {
 ...
 */
@customElement('flint-item-group')
export class FlintItemGroup extends LitElement {
 ...
 */
@customElement('flint-item')
export class FlintItem extends LitElement {
