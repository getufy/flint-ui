...
describe('ui-autocomplete', () => {
    ...
    it('renders placeholder on input', async () => {
        const el = await fixture<UiAutocomplete>(html`<ui-autocomplete placeholder="Search..."></ui-autocomplete>`);
        const input = el.shadowRoot!.querySelector('input')!;
    ...
    it('outside click with freeSolo=true does not reset inputValue', async () => {
        const el = await fixture<UiAutocomplete>(html`<ui-autocomplete .options=${options} ?freeSolo=${true}></ui-autocomplete>`);
        const input = el.shadowRoot!.querySelector('input')!;
