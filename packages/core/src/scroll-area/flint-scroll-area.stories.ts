...
### Components
- **\`flint-scroll-area\`** — Root container. Manages the viewport and built-in vertical/horizontal bars.
- **\`flint-scroll-bar\`** — Optional explicit scrollbar. Place with \`slot="scrollbar"\` for extra control.

### Usage
\`\`\`html
<flint-scroll-area style="height: 288px; width: 192px;">
...
\`\`\`html
<flint-scroll-area style="width: 384px;">
...
|---|---|---|
| \`--flint-scrollbar-size\`              | \`8px\`                   | Track width/height |
| \`--flint-scrollbar-thumb-color\`       | \`rgba(0,0,0,.35)\`       | Thumb fill |
| \`--flint-scrollbar-thumb-hover-color\` | \`rgba(0,0,0,.50)\`       | Thumb hover/drag fill |
| \`--flint-scrollbar-thumb-radius\`      | \`9999px\`                | Thumb border radius |
| \`--flint-scrollbar-track-color\`       | \`transparent\`           | Track background |
                `,
            },
        },
    },
