...
import uiAlertStyles from './flint-alert.css?inline';
        ...
        return html`
            <div class="alert ${classMap({ [this.severity]: true })}" part="base" role="alert"
                ...
                ${this.dismissible ? html`
                    <button class="close-button" part="close-button" @click=${this._handleClose} aria-label=${this._localize.term('close')}>
