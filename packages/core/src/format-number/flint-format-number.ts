 ...
 *
 * @cssprop --flint-format-number-color          - Text color (default: `inherit`).
 * @cssprop --flint-format-number-font-size      - Font size (default: `inherit`).
 * @cssprop --flint-format-number-font-weight    - Font weight (default: `inherit`).
 ...
 */
@customElement('flint-format-number')
export class FlintFormatNumber extends LitElement {
...
declare global {
    interface HTMLElementTagNameMap {
        'flint-format-number': FlintFormatNumber;
    }
}
