...
// Source: src/select/flint-option.component.ts
//
...
import { FlintOption as FlintOptionElement } from '@getufy/flint-ui/select/flint-option';
 ...
 *
 * @slot (default) - Option label text. Falls back to the `label` prop if empty.
 */
export interface FlintOptionProps extends React.HTMLAttributes<FlintOptionElement> {
...
export const FlintOption = createComponent({
    tagName: 'flint-option',
    elementClass: FlintOptionElement,
    react: React,
    events: {
...
}) as unknown as React.ForwardRefExoticComponent<FlintOptionProps & React.RefAttributes<FlintOptionElement>>;
