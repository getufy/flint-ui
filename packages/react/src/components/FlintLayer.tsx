...
// Source: src/layer/flint-layer.component.ts
//
...
import { FlintLayer as FlintLayerElement } from '@getufy/flint-ui/layer/flint-layer';
 ...
 */
export interface FlintLayerProps extends React.HTMLAttributes<FlintLayerElement> {
}

export const FlintLayer = createComponent({
    tagName: 'flint-layer',
    elementClass: FlintLayerElement,
    react: React,
    events: {
...
}) as unknown as React.ForwardRefExoticComponent<FlintLayerProps & React.RefAttributes<FlintLayerElement>>;
