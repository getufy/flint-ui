...
// Source: src/theme/flint-theme.component.ts
//
...
import { FlintTheme as FlintThemeElement } from '@getufy/flint-ui/theme/flint-theme';
...
export const FlintTheme = createComponent({
    tagName: 'flint-theme',
    elementClass: FlintThemeElement,
    react: React,
    events: {
...
}) as unknown as React.ForwardRefExoticComponent<FlintThemeProps & React.RefAttributes<FlintThemeElement>>;
