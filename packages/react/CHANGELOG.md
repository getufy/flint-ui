...
* The following workspace dependencies were updated
  * devDependencies
    * @getufy/flint-ui bumped from 0.8.3 to 0.8.4
  * peerDependencies
    * @getufy/flint-ui bumped from ^0.8.3 to ^0.8.4

## [0.8.3](https://github.com/getufy/flint-ui/compare/flint-ui-react-v0.8.2...flint-ui-react-v0.8.3) (2026-03-22)
...
* The following workspace dependencies were updated
  * devDependencies
    * @getufy/flint-ui bumped from 0.8.2 to 0.8.3
  * peerDependencies
    * @getufy/flint-ui bumped from ^0.8.2 to ^0.8.3

## [0.8.2](https://github.com/getufy/flint-ui/compare/flint-ui-react-v0.8.1...flint-ui-react-v0.8.2) (2026-03-17)
...
* The following workspace dependencies were updated
  * devDependencies
    * @getufy/flint-ui bumped from 0.8.1 to 0.8.2
  * peerDependencies
    * @getufy/flint-ui bumped from ^0.8.1 to ^0.8.2

## [0.8.1](https://github.com/getufy/flint-ui/compare/flint-ui-react-v0.8.0...flint-ui-react-v0.8.1) (2026-03-17)
...
* The following workspace dependencies were updated
  * devDependencies
    * @getufy/flint-ui bumped from 0.8.0 to 0.8.1
  * peerDependencies
    * @getufy/flint-ui bumped from ^0.8.0 to ^0.8.1
